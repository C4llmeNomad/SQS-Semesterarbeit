\chapter{Automatisierte UI Tests}
	...
	\section{Anwendung}
		...
		\paragraph{} Die Anwendung lässt sich in 4 Bereiche Unterteilen. Der erste Bereich, links oben, ist ein Text Feld. Dieses Text Feld kann mit User Input gefüllt werden.  
